...
The account appears in the Banking & Cash group immediately with a $0.00
balance. Import a CSV or OFX/QFX file to populate transactions.
...
numbers (money owed) once you import transactions.
...
the Accounts page. Banking & Cash and Liability accounts show a $0.00 balance
until transactions are imported. Retirement, investment, and real estate
accounts show the balance from the first snapshot you recorded.
...
transaction file (CSV or OFX/QFX) from the account's transaction page.
For retirement, investment, and real estate accounts, record a balance
snapshot from the Assets or Reports page.
