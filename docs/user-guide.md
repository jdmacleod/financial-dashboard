...
**Estimated tax:** When your household has a filing status set (Settings → Household & tax), an **Estimated federal tax** panel shows the federal income tax over the period's full taxable income, your after-tax income, and your marginal rate. Qualified income (long-term capital gains and qualified dividends) is taxed at preferential rates on its own line, and higher earners with investment income also see a federal net investment income tax (NIIT) line. A federal alternative minimum tax (AMT) line appears when the parallel AMT comes out higher than your regular tax. The AMT is driven by preference items you enter under Settings → Household & tax: your annual state/local tax add-back and your incentive-stock-option exercise spread. Without those, the standard-deduction add-back alone does not trigger AMT, so the line stays hidden. If you also set your state of residence, a **state income tax** line appears: a full estimate for California, New York, Georgia, and Illinois; a $0 with a note for the eight no-income-tax states (Texas, Florida, Tennessee, and the rest); and a "not yet modeled" note for any other state. For Illinois, Georgia, and New York the estimate applies that state's retirement-income exclusion to your pensions and RMDs (Illinois excludes them in full; Georgia and New York are age-based, using your household members' dates of birth, and a married couple where both qualify gets the per-person caps added together), and the line shows how much was excluded. All figures are planning estimates, not tax preparation: they exclude credits and itemized deductions, the AMT state/local add-back assumes you itemize while the estimate uses the standard deduction, and state estimates tax capital gains as ordinary income and exclude Social Security.
